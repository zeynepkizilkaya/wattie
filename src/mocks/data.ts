...
export const mockHomes: Home[] = [
  {
    ...
    billingAmountTry: calculateTieredBilling(128.5, 45.2).totalBill,
    penaltyActive: false,
    powerQuotaKwh: 300,
    financialQuota: 750,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(245.1, 82.7).totalBill,
    penaltyActive: false,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(412.6, 112.5).totalBill,
    penaltyActive: true,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(189.3, 67.4).totalBill,
    penaltyActive: false,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(520.4, 133.6).totalBill,
    penaltyActive: true,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(45.2, 23.1).totalBill,
    penaltyActive: false,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(685.2, 152.3).totalBill,
    penaltyActive: true,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
  ...
  },
  {
    id: 'h8',
    name: 'Depo - Tuzla',
    quotaUsagePercent: 562.0,
    totalConsumptionKwh: 1240.92,
    billingAmountTry: calculateTieredBilling(1240.92, 562.0).totalBill,
    penaltyActive: true,
    powerQuotaKwh: 220.78,
    financialQuota: 750,
    normalTariffRate: 2.07,
    penaltyTariffRate: 5.18,
    appliances: [
  ...
  },
  {
    ...
    billingAmountTry: calculateTieredBilling(198.7, 91.4).totalBill,
    penaltyActive: false,
    powerQuotaKwh: 300,
    financialQuota: 750,
    normalTariffRate: 2.07,
